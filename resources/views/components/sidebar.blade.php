    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown">
                <a href="#" class="nav-link has-dropdown"><i class="fas fa-gauge"></i><span>Dashboard</span></a>
            ...
            <li class="nav-item dropdown">
                <a href="#" class="nav-link has-dropdown"><i class="fas fa-utensils"></i><span>Products</span></a>
                <ul class="dropdown-menu">
                    <li>
